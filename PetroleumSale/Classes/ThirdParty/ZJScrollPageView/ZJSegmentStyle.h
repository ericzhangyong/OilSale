...
/** 是否可以多次点击标题 只把响应事件传出来（不做其他操作） 默认为NO */
@property (assign, nonatomic, getter=isTapTitleOneMoreTimes) BOOL tapTitleOneMoreTimes;
...
/** 滚动条的宽度 必须在isAdjustCoverOrLineWidth ＝NO */
